...
namespace menu {
	...
	SkinMenu::SkinMenu(const std::string& modelpath, const std::string& texturepath)
	{
		...
		m_Light = std::make_unique<Light>(glm::vec3(3000, 2000, 3000), glm::vec3(1, 1, 1));
		m_Camera = std::make_unique<Camera>(glm::vec3(0, 3, 10));
	...
	{
		ImGui::SliderFloat3("Translation", &m_Translation.x, -35.0f, 35.0f);
